...
CombatScene.Game_Action_needCombatScene = Game_Action.prototype.needCombatScene;
Game_Action.prototype.needCombatScene = function() {
    return CombatScene.Game_Action_needCombatScene.call(this) && !this.isTeleport();
};
...
Scene_Combat.prototype = Object.create(Scene_Message.prototype);
...
Scene_Combat.prototype.createLogWindow = function() {
    const rect = Scene_Battle.prototype.logWindowRect.call(this);
